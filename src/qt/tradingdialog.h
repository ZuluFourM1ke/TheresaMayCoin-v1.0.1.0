...
private slots:
    ...
    void on_BuyBorisCoin_clicked();
    void on_SellBorisCoinBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputBorisCoin_textChanged(const QString &arg1);
    ...
    QString BuyBorisCoin(QString OrderType, double Quantity, double Rate);
    QString SellBorisCoin(QString OrderType, double Quantity, double Rate);
