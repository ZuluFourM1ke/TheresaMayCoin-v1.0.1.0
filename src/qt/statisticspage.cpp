...
void StatisticsPage::updateStatistics()
{
    ...
    {
        ui->heightBox->setText("<b><font color=\"maroon\">" + height + "</font></b>");
    } else {
    ...
    if(nHeight < 201)
        {
            ui->rewardBox->setText("<b><font color=\"maroon\">0 PoW+PoS</font></b>");
        }
        else if(nHeight < 12001)
        {
            ui->rewardBox->setText("<b><font color=\"maroon\">10 PoW+PoS</font></b>");
        }
        else if(nHeight < 32001)
        {
            ui->rewardBox->setText("<b><font color=\"maroon\">50 PoW+PoS</font></b>");
        }
        else if(nHeight < 62001)
        {
            ui->rewardBox->setText("<b><font color=\"maroon\">100 PoW+PoS</font></b>");
        }
        else if(nHeight < 102001)
        {
            ui->rewardBox->setText("<b><font color=\"maroon\">200 PoW+PoS</font></b>");
        }
        else if(nHeight < 152001)
        {
            ui->rewardBox->setText("<b><font color=\"maroon\">400 PoW+PoS</font></b>");
        }
        else if(nHeight < 212001)
        {
            ui->rewardBox->setText("<b><font color=\"maroon\">800 PoW+PoS</font></b>");
        }
        else if(nHeight < 216901)
        {
           ui->rewardBox->setText("<b><font color=\"maroon\">1000 PoW+PoS</font></b>");
        }
        else if(nHeight > 216900)
        {
            ui->rewardBox->setText("<b><font color=\"maroon\">1% per annum PoS</font></b>");
        }


    if(0 > stakeminPrevious)
    {
        ui->minBox->setText("<b><font color=\"maroon\">" + stakemin + "</font></b>");
    } else {
    ui->minBox->setText(stakemin);
    }
    if(0 > stakemaxPrevious)
    {
        ui->maxBox->setText("<b><font color=\"maroon\">" + stakemax + "</font></b>");
    } else {
    ...
    {
        ui->cBox->setText("<b><font color=\"maroon\">" + phase + "</font></b>");
    } else {
    ...
    {
        ui->diffBox->setText("<b><font color=\"maroon\">" + hardness + "</font></b>");
    } else {
    ...
    {
        ui->diffBox2->setText("<b><font color=\"maroon\">" + hardness2 + "</font></b>");
    } else {
    ...
    {
        ui->pawrateBox->setText("<b><font color=\"maroon\">" + pawrate + " MH/s</font></b>");
    } else {
    ...
    {
        ui->localBox->setText("<b><font color=\"maroon\">" + Qlpawrate + "</font></b>");
    } else {
    ...
    {
        ui->connectionBox->setText("<b><font color=\"maroon\">" + QPeers + "</font></b>");
    } else {
    ...
    {
        ui->volumeBox->setText("<b><font color=\"maroon\">" + qVolume + " MAY" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " MAY");
    }
