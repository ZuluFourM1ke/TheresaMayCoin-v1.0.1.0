...
const string strMessageMagic = "TheresaMay Signed Message:\n";
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "British Prime Minister Theresa May calls for general election June 8";
        CTransaction txNew;
        txNew.nTime = 1492598117;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1492598117;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 8716130;
        ...
        assert(block.hashMerkleRoot == uint256("0xa18a0598ee6c23fbc32d7de68b27caf71f3992b24ea1eef6f0e86fbd61be3c29"));
